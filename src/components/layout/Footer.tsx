...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#FAF8F5] py-6 sm:py-10 md:py-12 text-xs">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="bg-[#ECE7DF] text-stone-800 rounded-none p-6 sm:p-10 md:p-12 shadow-sm border border-[#DDD6CA] space-y-8 sm:space-y-12">
