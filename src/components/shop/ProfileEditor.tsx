                ...
                <div className="pt-3 border-t space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-[11px] text-zinc-400 hover:text-zinc-700 flex items-center gap-1 cursor-pointer"
                    >
                  ...
                  <div className="space-y-2">
                    <input
                      ...
                      className="w-full px-3.5 py-2 bg-zinc-50 rounded-xl border text-xs focus:outline-none focus:ring-2 focus:ring-zinc-900 font-mono"
                    />
                    <input
                      type={showPassword ? "text" : "password"}
