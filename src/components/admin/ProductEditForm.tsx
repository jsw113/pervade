...
import { Upload, Plus, Trash2, Image as ImageIcon, Star, Check, Link2, Layers, AlertCircle } from "lucide-react";
...
export function ProductEditForm({ product }: { product: any }) {
  ...
  // Options state
  let parsedOptions: ProductOption[] = DEFAULT_OPTIONS_PRESET;
  try {
    if (product.options) {
    ...
    parsedOptions = DEFAULT_OPTIONS_PRESET;
  }
