...
export default async function AdminDashboard() {
  ...
  const quickLinks = [
    ...
    { title: "PROMOTION", desc: "메인 배너 할인 페스티벌 & 지난 이벤트", href: "/admin/promotions", icon: Megaphone, count: `${promoCount}개 진행중` },
    { title: "COUPON", desc: "쿠폰 발급, 할인율 및 재고 관리", href: "/admin/coupons", icon: Settings, count: "쿠폰 마스터" },
